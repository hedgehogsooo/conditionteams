...
Данный код может содержать ошибки, авторы не несут никакой ответственности за любые последствия использования этого кода.
...
Перед запуском убедитесь, что во всех файла папки shared установлено значение 0. 
